...
/*Reads the paths from file and stores them in an array that is returned.
...
//send load only to 1 worker
void DistributePath(pid_t* Children, char** Paths, int numPaths,
                                  int* OpenToPipes, int wrk_num);
